...
public class FixPreviewRenderer {
    ...
    public String formatCandidateLine(int index, MethodInfo method, String currentQuery) {
        ...
        return String.format(
                ...
                index,
                textSupport.highlightTerms(textSupport.safe(textSupport.displayContainer(method)), terms),
                textSupport.highlightTerms(textSupport.safe(textSupport.displaySymbol(method)), terms),
                scorePart,
